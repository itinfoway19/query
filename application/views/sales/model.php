...
$formParty_wight = array(
    'type' => 'text',
    'name' => 'party_weight',
    'id' => 'party_weight',
    'data-validation' => "number",
    "data-validation-allowing" => "range[0;99999]",
    'class' => 'form-control',
    "placeholder" => "Enter Party Wight",
    'value' => isset($party_weight) ? $party_weight : "",
);
$formRate = array(
    'type' => 'text',
    'name' => 'rate',
            ...
            <div class="modal-body">
                <div class="col-12">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>party wight</label>
                                <?= form_input($formParty_wight); ?>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Amount</label>
                                <input id="amount" readonly class="form-control"> 
                            </div>
                        </div>
                    </div><!--row over-->
                    <div class="row">
...
<script>
    ...
    function setupValidation() {
        $.validate({
            lang: 'en',
            modules: 'file', onSuccess: function ($form) {
    ...
    function amount() {
        var net = parseInt($("#net_weight").val());
        var pwe = parseInt($("#party_weight").val());
        var rate = parseFloat($("#rate").val());
        var gst = parseFloat($("#gst").val());
        var amount = ((pwe == 0) ? (net * rate) : (pwe * rate)) / 1000;
        var gstamount = (gst == 0) ? amount : ((amount * gst) / 100) + amount;
        $("#amount").val(gstamount);
    }
    amount();
    $(document).on("keyup", "#vehicle_id,#gross_weight,#net_weight,#party_weight,#rate,#gst", function () {
        amount();
    });
    $(document).on("chnage", "#gross_weight,#vehicle_id,#net_weight,#party_weight,#rate,#gst", function () {
        amount();
    });
</script>
